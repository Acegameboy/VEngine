...
void VEngine::Graphics::VertexShader::Initialize(const std::filesystem::path& filePath, uint32_t format)
{
...
void VEngine::Graphics::VertexShader::Terminate()
{
	SafeRelease(mInputLayout);
	SafeRelease(mVertexShader);
}

void VEngine::Graphics::VertexShader::Bind()
{
