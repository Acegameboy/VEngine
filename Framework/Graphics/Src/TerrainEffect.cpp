...
void VEngine::Graphics::TerrainEffect::Initialize()
{
...
void VEngine::Graphics::TerrainEffect::Terminate()
{
	mSampler.Terminate();
...
void VEngine::Graphics::TerrainEffect::Begin()
{
	mVertexShader.Bind();
	mPixelShader.Bind();
...
void VEngine::Graphics::TerrainEffect::End()
{
...
void VEngine::Graphics::TerrainEffect::Render(const RenderObject& renderObject)
{
...
void VEngine::Graphics::TerrainEffect::DebugUI()
{
...
void VEngine::Graphics::TerrainEffect::SetCamera(const Camera& camera)
{
	mCamera = &camera;
}

void VEngine::Graphics::TerrainEffect::SetLightCamera(const Camera& lightCamera)
{
	mLightCamera = &lightCamera;
}

void VEngine::Graphics::TerrainEffect::SetDirectionalLight(const DirectionalLight& directionalLight)
{
	mDirectionalLight = &directionalLight;
}

void VEngine::Graphics::TerrainEffect::SetShadowMap(const Texture& shadowMap)
{
