...
using namespace VEngine::Math::Constants;
...
namespace
{
	...
	{
		std::filesystem::path shaderPath = L"../../Assets/Shaders/DoTransformColor.fx";
...
void SimpleDraw::AddTransform(const Math::Matrix4& matrix)
{
