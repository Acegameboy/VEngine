...
Transform VEngine::Graphics::Animation::GetTransform(float time) const
{
	Transform transform;
...
float VEngine::Graphics::Animation::GetDuration() const
{
	return mDuration;
}
...
Math::Quaternion VEngine::Graphics::Animation::GetRotation(float time) const
{
...
Math::Vector3 VEngine::Graphics::Animation::GetScale(float time) const
{
	if (mScaleKeys.empty())
	{
