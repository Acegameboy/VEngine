...
#define VERTEX_FORMAT(fmt)\
	...
	struct Vertex
	{
		//Sets the vertex input data expected to be passed to the shader (position, normal, tangent, texcoord, blendIndices and blendWeight)
		//Must match infor in the shader
